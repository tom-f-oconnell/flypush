...
class Table:
    ...
    @staticmethod
    def column_field(column_info):
        """Takes str w/ Postgres type to appropriate wtform Field class.
        """
        # TODO TODO TODO for foreign key fields, should be a select area
        ...
        if type_str == 'integer' or type_str == 'smallint':
    ...
    def add_row_form(self, request_form):
        ...
        # TODO types to support: bool, enum, selection for foreign key, text,
        # number, and is here the right place to get picture inputs
        # w/ <input type="file" accept"image/*" multiple/> ?
